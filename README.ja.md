...
`Self/thoughts/` に何でも書き殴る。生煮えのアイデア、ふと思ったこと。そんな思いつきでもClaudeが咀嚼すれば宝になるかもしれない。経験・出来事は `Self/journal/`、価値観・信念は `Self/values/`、重要な意思決定は `Self/decisions/` に記録する——デジタルクローンの素材となるデータが蓄積される。
...
├── Self/                 # 内なる世界 — デジタルクローンの素材
│   ├── thoughts/         # 自由な思考 — 何でも書く
│   ├── journal/          # 経験・出来事・日々の振り返り
│   ├── values/           # 価値観・信念・判断軸
│   └── decisions/        # 重要な意思決定とその理由
